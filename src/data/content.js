...
export const hero = {
  video: `${IMG}/homevideo.mp4`,
  poster: `${IMG}/madhusudan.png`,
  eyebrow: "78+ Years of Legacy",
  title: "MUREC",
  sub: "Madhusudan Urban Real Estate Collection",
...
export const explorer = [
  {
    key: "legacy",
    tab: "Legacy",
    heading: "THE LEGACY BEYOND COMPARE",
  ...
  people: [
    {
      ...
      mark: `${IMG}/bobyloog.png`,
    },
    {
      photo: `${IMG}/team_3.webp`,
      name: "Goonmeet Ji",
      quote:
...
export const footer = {
  ...
  copyright: "Copyright © 2026 | Privacy Policy",
  social: [
